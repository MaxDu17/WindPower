...
version = 2
version_to_keep = 159700

MODEL_NAME = 'LSTM_v' + str(version) + '_genetic_frozen'
#MODEL_NAME = 'gru_c_genetic_frozen'
# Freeze the graph

input_graph_path = '../Graphs_and_Results/lstm_v' + str(version) + '_c_class_PULL/GRAPHS/graph.pbtxt'
#input_graph_path = '../Graphs_and_Results/gru_c_class/GRAPHS/graph.pbtxt'


checkpoint_path = '../Graphs_and_Results/lstm_v' + str(version) + '_c_class_PULL/models/V' + str(version) + 'Genetic-' + str(version_to_keep)
...
output_frozen_graph_name = '../Graphs_and_Results/lstm_v' + str(version) + '_c_class_PULL/'+MODEL_NAME+'.pb'
